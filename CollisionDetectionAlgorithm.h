...
//output the bits of cvi[31, 27, 22,17, 11, 8], bit selected order is 31, 27, 22, 17, 11, 8
#define GetAdditionalBits(scc1, scc2, scc3, scc4, scc5,scc6, cvi)   (\
	scc1 <<= 1, scc1 |=   cvi >> 31,					  \
	scc2 <<= 1, scc2 |= ((cvi >>  27) & 0x00000001),	  \
	scc3 <<= 1, scc3 |= ((cvi >>  22) & 0x00000001),	  \
	scc4 <<= 1, scc4 |= ((cvi >>  17) & 0x00000001),	  \
	scc5 <<= 1, scc5 |= ((cvi >> 11) & 0x00000001),	  \
	scc6 <<= 1, scc6 |= ((cvi >> 8) & 0x00000001) )
// define can't have blank line
